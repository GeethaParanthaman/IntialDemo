...
public class Advanced_Selenium {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(withTagName("input").below(dateLabel)).sendKeys("1990-09-21");
		Thread.sleep(3000);
		...
		System.out.println(driver.findElement(withTagName("label").toRightOf(radioButtonClick)).getText());
